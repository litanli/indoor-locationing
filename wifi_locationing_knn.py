...
Goal:        Benchmark 3 indoor locationing solutions using the UJIIndoorLoc 
             ...
             In this script, we'll use a knn classifier.
...
Conclusion:  Please read my "Evaluate Techniques for Wi-Fi Locationing" technical 
             ...
             Final Model: "KNeighborsClassifier_model.sav"
             metric: manhattan
             n_neighbors: 1
             
             Tuning insights:
             See "tuning_knn.csv" for results of all hyperparameter combinations 
             tried. A 1NN with the manhattan distance performed best on the
             validation set.
             
             Reason: gives good cross-validation scores. There’s some 
             overfitting, suggested by the 14% gap between the cross-validation 
             score and the average training set score across the folds. 
             
             Training set performance (average of k-folds): 
             accuracy 0.966 kappa 0.966
             
             Cross validation performance: 
             accuracy 0.818 kappa 0.818
